...
<div align="center"
    ...
    <form class="layui-form layui-form-pane" method="post">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">借阅者帐号</label>
            <div class="layui-input-inline">
                <input type="text" name="userid" lay-verify="required"
                       placeholder="请输入借阅者账号" autocomplete="off" class="layui-input"><br>
            </div>
        ...
        <div class="layui-form-item" align="center">
            <input type="submit" class="layui-btn layui-btn-warm" lay-submit="" lay-filter="demo2" onclick="javascript:void(0);">
        </div>
    </form>
