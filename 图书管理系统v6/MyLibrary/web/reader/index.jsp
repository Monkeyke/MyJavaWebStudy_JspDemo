...
<%--	个人信息--%>
	...
	<div class="container">
		...
		<h1>个人信息
			<span class="glyphicon glyphicon-bookmark" aria-hidden="true" style="font-size:17px;">&nbsp;你可以修改你的密码</span>
		</h1>
		</header>
...
<%
		...
		List<Borrow_cardBean> list = qr.query(sql,new BeanListHandler<>(Borrow_cardBean.class),cardId);
			for (int i = 0; i < list.size(); i++) {
%>
				<p><span class="glyphicon glyphicon-tags">&nbsp;借阅证编号：<%=list.get(i).getId()%></span></p><br>
				<p><span class="glyphicon glyphicon-user">&nbsp;借阅证姓名：<%=list.get(i).getReader()%></span></p><br>
				<p><span class="glyphicon glyphicon-tag">&nbsp;规则编号：<%=list.get(i).getRule_id()%></span></p><br>
